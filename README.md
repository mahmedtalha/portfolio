    ...
    <nav id="navbar">
        <div class="nav-container">
            <a href="#" class="logo">
                ...
                <span class="logo-text">Muhammad Ahmed <span class="accent">Talha</span></span>
            </a>
            <div class="nav-links">
            ...
            <div class="hero-content">
                ...
                <h2 class="hero-subtitle">
                    <span class="typewriter"
                        data-words='["Cybersecurity Specialist", "IT Assistant Manager", "Penetration Tester", "Red Team Specialist", "Security Automation Dev"]'>Cybersecurity
                        Specialist</span>
                </h2>
                <p class="hero-bio">
                    ...
                    Currently IT Assistant Manager at Toyota Royal Motors.
                </p>
            ...
            <div class="hero-visual">
                <div class="portrait-card">
                    ...
                    <div class="floating-badge badge-2">
                        ...
                        <span>IT Infrastructure Manager & Cybersecurity Specialist</span>
                    </div>
                    <div class="floating-badge badge-3">
                        <i class="fas fa-building"></i>
                        <span>IT Assistant Manager @ TRM & CSML</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="about-grid">
                ...
                <div class="about-content reveal">
                    ...
                    <p class="about-description">
                        In my role as <strong>IT Assistant Manager at Toyota Royal Motors</strong>, I manage networks,
                        SQL
        ...
        <div class="container">
            ...
            <div class="projects-grid">
                ...
                <div class="project-card reveal">
                    ...
                    <h3>Information Gathering Framework</h3>
                    <p>Python-based automated security assessment tool integrating domain enumeration, IP lookup, port
                        scanning, and OSINT reconnaissance.</p>
                ...
                <div class="project-card reveal">
                    ...
                    <p>Python reconnaissance tool designed to trace usernames and email accounts across hundreds of
                        online platforms, generating structured investigation reports.</p>
                    <div class="tech-stack">
                ...
                <div class="project-card reveal">
                    ...
                    <h3>Wi-Fi Deauth Detector NodeMCU</h3>
                    <p>Hardware defense tool built on NodeMCU ESP8266 to continuously monitor airwaves for 802.11
                        deauthentication attacks and alert admins in real time.</p>
                    <div class="tech-stack">
                ...
                <div class="project-card reveal">
                    ...
                    <h3>Slowloris Advanced DoS Simulator</h3>
                    <p>Advanced implementation of Slowloris HTTP DoS attack simulator to evaluate web server connection
                        resilience and socket handling mechanisms.</p>
                    <div class="tech-stack">
        ...
        <div class="container">
            ...
            <div class="contact-grid">
                <div class="contact-info reveal">
                    ...
                    <!-- Direct Google Form Contact Card -->
                    <div class="google-form-card">
                        <div class="gf-header">
                            <i class="fab fa-google gf-icon"></i>
                            <div>
                                <h4>Official Contact Form</h4>
